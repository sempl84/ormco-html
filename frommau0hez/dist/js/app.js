    ...
    (() => {
            ...
            document.addEventListener("click", (function(e) {
                ...
                if (targetElement.closest(".quantity__button")) {
                    ...
                    if (targetElement.classList.contains("quantity__button_plus")) {
                        value++;
                        if (value > 1) targetElement.parentElement.querySelector(".quantity__button_minus").classList.remove("quantity__button_disabled");
                    } else {
                        --value;
        ...
        function initSliders() {
            ...
            if (document.querySelector(".article__slider")) {
                let breakpoints;
                if (document.querySelector(".model_product")) breakpoints = {
                    320: {
                        slidesPerView: 2.115,
                        spaceBetween: 12
                    },
            ...
            if (document.querySelector(".head-tubes__slider")) new core(".head-tubes__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                spaceBetween: 20,
            ...
            if (document.querySelector(".sliders-model__main")) new core(".sliders-model__main", {
            ...
            function pageNavigationAction(e) {
                if ("click" === e.type) {
                    ...
                    if (targetElement.closest("[data-goto]")) {
                        ...
                        if (gotoLink.dataset.gotoTopMobile && window.innerWidth > 1020) gotoBlock(gotoLinkSelector, noHeader, gotoSpeed, offsetTopMobile); else gotoBlock(gotoLinkSelector, noHeader, gotoSpeed, offsetTop);
                        e.preventDefault();
                    }
...
***************************************************************************** */
        ...
        (function($, window, document, undefined) {
            ...
            $.extend(Plugin.prototype, {
                ...
                updateOriginalInput: function() {
                    ...
                    if (newValue.length !== this.settings.inputs) $(".pincode-input-text", this._container).removeClass("filled");
                },
                check: function() {
                    let isComplete = true;
                    let code = "";
                    $(".pincode-input-text", this._container).each((function(index, value) {
                        ...
                        if (!$(value).val()) isComplete = false;
                    }));
                    if (this._isTouchDevice()) {
                        if (code.length == this.settings.inputs) return true;
                ...
                buildInputBoxes: function() {
                    ...
                    if (false == this.settings.hidedigits && "" != $(this.element).val()) currentValue = $(this.element).val().split("");
                    ...
                    if (this._isTouchDevice()) {
                        ...
                        let digitEms = this.settings.characterwidth || (this.settings.hidedigits ? .4 : .54);
                        setTimeout((function() {
                        ...
                        for (let i = 0; i < this.settings.inputs; i++) if (i == this.settings.inputs - 1) $("<div/>").addClass("touch-flex-cell").addClass("last").appendTo(touchtable); else $("<div/>").addClass("touch-flex-cell").appendTo(touchtable);
                        if (this.settings.hidedigits) input.addClass("pincode-input-text-masked"); else input.val($(this.element).val());
                        ...
                        for (let i = 0; i < this.settings.inputs; i++) {
                            ...
                            if (this.settings.hidedigits) input.addClass("pincode-input-text-masked"); else input.val(currentValue[i]);
                            if (0 == i) input.addClass("first"); else if (i == this.settings.inputs - 1) input.addClass("last"); else input.addClass("mid");
                ...
                _setValue: function(newValue, e) {
                    ...
                    if (this._isTouchDevice()) {
                        ...
                        this.updateOriginalInput();
                        if (this.check()) this.settings.complete($(this.element).val(), e, this._error);
                    } else {
                ...
                _isTouchDevice: function() {
                    ...
                    if ("MacIntel" === navigator.platform && navigator.maxTouchPoints > 1) return true;
                },
                _addEventsToInput: function(input, inputnumber) {
                    input.on("focus", $.proxy((function(e) {
                        if (this._isTouchDevice()) this._setValue("", e);
                        input.select();
                    }), this));
                    ...
                    input.on("keydown", $.proxy((function(e) {
                        ...
                        if (this._isTouchDevice()) {
                            if (8 == e.keyCode || 46 == e.keyCode) ; else if ($(this.element).val().length == this.settings.inputs) {
                                e.preventDefault();
                                e.stopPropagation();
                            } else if ($(this.element).val().length == this.settings.inputs - 1) $(e.currentTarget).addClass("filled");
                        } else if (!(8 == e.keyCode || 9 == e.keyCode || 46 == e.keyCode || e.keyCode >= 48 && e.keyCode <= 57 || e.keyCode >= 96 && e.keyCode <= 105 || e.ctrlKey || e.metaKey || "number" != this.settings.inputtype && "tel" != this.settings.inputtype && e.keyCode >= 65 && e.keyCode <= 90)) {
                            e.preventDefault();
                            e.stopPropagation();
                        }
                    ...
                    input.on("keyup", $.proxy((function(e) {
                        if (!this._isTouchDevice()) if (8 == e.keyCode || 46 == e.keyCode) {
                        ...
                        if (this._isTouchDevice()) if (8 == e.keyCode || 46 == e.keyCode) ; else if ($(this.element).val().length == this.settings.inputs) $(e.currentTarget).blur();
                        if (this.check()) if (this._isTouchDevice()) setTimeout($.proxy((function() {
                            this.settings.complete($(this.element).val(), e, this._error);
                        }), this), 100); else this.settings.complete($(this.element).val(), e, this._error);
                    }), this));
                }
            });
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            if (shortModel) {
                ...
                window.addEventListener("scroll", (() => {
                    if (window.innerWidth < 767 && window.scrollY > 650) shortModel.hidden = false; else shortModel.hidden = true;
                }));
            }
            document.addEventListener("click", (e => {
                if (filtersItems.length) {
                    let checkfilters = document.querySelector(".checkfilters");
                    filtersActions(filtersItems, checkfilters);
                    if (e.target.classList.contains("spollers-breckets__reset")) setTimeout((() => {
                        filtersActions(filtersItems, checkfilters);
                    }), 100);
                }
            }));
                ...
                checkfilterClose.addEventListener("click", (() => {
                    ...
                    filtersItems.forEach((el => {
                        ...
                        if (title === key) {
                            ...
                            labels.forEach((e => {
                                if (e.textContent === value) e.click();
                            }));
                        }
                    }));
                }));
        ...
        function homePageFunctions() {
            ...
            $(document).on("click touchstart", (function(e) {
                let div = $(".phones_nav");
                if (!div.is(e.target)) div.removeClass("opened");
            }));
            ...
            $('input[type="radio"]').on("change", (function() {
                ...
                if ("another" === $(this).val()) $(this).closest(".input-field-hide").find(".input-field-hidden").slideDown(200);
            }));
            new Swiper(".topslider .swiper", {
                slidesPerView: 1,
                spaceBetween: 10,
                navigation: {
            ...
            new Swiper(".popupar_products .swiper", {
                slidesPerView: 1,
                spaceBetween: 20,
                navigation: {
            ...
            $(".spoiler_name").click((function() {
                $(this).html("Открыть спойлер" == $(this).text() ? "Закрыть спойлер" : "Открыть спойлер");
            ...
            $(".check-select").each((function() {
                let val = "";
                let values = [];
                let title = $(this).find(".check-select__select").text();
                $(this).find(".check-select__select").on("click", (function() {
                    if (!$(this).hasClass("active")) {
                        $(".check-select__select").removeClass("active");
                        $(".check-select__dropdown").fadeOut(200);
                        $(this).addClass("active");
                        $(this).closest(".check-select").find(".check-select__dropdown").fadeIn(100);
                    } else {
                ...
                $(this).find('input[type="checkbox"]').on("change", (function() {
                    val = $(this).val();
                    if (true === $(this).prop("checked")) values.push(val); else values = values.filter((item => item !== val));
                }));
            ...
            $(document).on("click touchstart", (function(event) {
                ...
                let checkSelect = $(".check-select");
                if (!customSelect.is(event.target) && 0 === customSelect.has(event.target).length) {
                    customSelect.removeClass("focused");
                    customSelect.find(".custom_select__dropdown").fadeOut(50);
                }
                if (!checkSelect.is(event.target) && 0 === checkSelect.has(event.target).length) {
                    checkSelect.find(".check-select__select").removeClass("active");
                    checkSelect.find(".check-select__dropdown").fadeOut(50);
                }
            }));
            let manyHeight = $(".filter_header_left .many_inner").outerHeight();
            let manyText = $(".filter_header_more").text();
            $(".filter_header_more").on("click", (function() {
                if (!$(this).hasClass("active")) {
                    $(this).addClass("active");
                    $(".filter_header_left.many").css("height", manyHeight);
                    $(this).text("Показать меньше");
                } else {
                    $(this).removeClass("active");
                    $(".filter_header_left.many").removeAttr("style");
                    $(this).text(manyText);
                }
                return false;
            }));
            const configChooseTeeth = (id, classname) => {
                $(`#${id}`).on("click", (function() {
                    $(`.${classname} input[type="checkbox"]`).not(":disabled").each((function() {
                        if (false === $(this).prop("checked")) $(this).prop("checked", true);
                    }));
                }));
            };
            ...
            $(".order_spoiler_head, .filters_item_title").on("click", (function() {

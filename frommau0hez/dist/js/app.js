            ...
            document.addEventListener("click", (function(e) {
                ...
                if (targetElement.closest(".quantity__button")) {
                    ...
                    if (targetElement.classList.contains("quantity__button_plus")) {
                        ...
                        --value;
                        if (value <= max) targetElement.parentElement.querySelector(".quantity__button_plus").classList.remove("quantity__button_disabled");
                        if (min && value <= min) {
                            value = min;
...
***************************************************************************** */
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            if (legalFaceInput) legalFaceCheck(legalFaceInput);
            const cartElement = document.querySelector(".cart");
            if (cartElement && document.querySelector(".page_cart")) cartActions(cartElement);
            const orderingAdresses = document.querySelectorAll(".popupAddress__radio");
            if (orderingAdresses) orderingAdressesActions(orderingAdresses);
        ...
        function shortModelShow(shortModel) {
            if (window.innerWidth < 767 && window.scrollY > 650 && document.querySelector(".page_model")) shortModel.hidden = false; else if ((document.querySelector(".page_cart") || document.querySelector(".page_ordering")) && window.innerWidth < 767) shortModel.hidden = false; else shortModel.hidden = true;
        }
        function legalFaceCheck(legalFaceInput) {
            ...
            if (legalFaceInput.checked) legalFaceAttrs.hidden = false; else legalFaceAttrs.hidden = true;
        ...
        function cartActions(cartElement) {
            function cartCheckboxes() {
                ...
                setTimeout((() => {
                    if (cartElement.querySelector(".products-cart__delquan")) {
                        ...
                        if (checkboxesChecked.length) document.querySelector(".products-cart__delquan").innerHTML = `(${checkboxesChecked.length})`; else document.querySelector(".products-cart__delquan").innerHTML = ``;
                    }
                }), 600);
                if (checkboxes.length) checkboxes.forEach((el => {
                    el.addEventListener("change", (() => {
                        const checkboxesChecked = cartElement.querySelectorAll(".products-cart__checkbox:checked");
                        if (document.querySelector(".products-cart__delquan")) if (checkboxesChecked.length) document.querySelector(".products-cart__delquan").innerHTML = `(${checkboxesChecked.length})`; else document.querySelector(".products-cart__delquan").innerHTML = ``;
                        if (checkboxes.length === checkboxesChecked.length) checkboxAll.checked = true; else checkboxAll.checked = false;
                    }));
                })); else if (cartElement.querySelector(".products-cart__head")) cartElement.querySelector(".products-cart__head").remove();
                if (checkboxAll) checkboxAll.addEventListener("change", (() => {
                    if (checkboxAll.checked) checkboxes.forEach((e => {
                        e.checked = true;
                    })); else checkboxes.forEach((e => {
                        e.checked = false;
                    }));
            ...
            function cartDel() {
                ...
                if (delAllAvaiableBtn) delAllAvaiableBtn.addEventListener("click", (() => {
                    const checkboxesChecked = cartElement.querySelectorAll(".products-cart__checkbox:checked");
                    if (checkboxesChecked.length) checkboxesChecked.forEach((el => {
                ...
                if (delAllUnavaiableBtn) delAllUnavaiableBtn.addEventListener("click", (() => {
                ...
                if (delProductBtn.length) delProductBtn.forEach((el => {
                ...
                if (delSubProductBtn.length) delSubProductBtn.forEach((el => {
                    el.addEventListener("click", (() => {
            ...
            function cartPrices() {
                ...
                if (cartProducts.length) {
                    cartProducts.forEach((cartProduct => {
                        ...
                        if (!cartProductSubProducts.length) if (cartProductNewPrice) {
                            ...
                            if (cartPrice.toString().length > 4) cartPriceEl.querySelector("span").innerHTML = cartPrice.toLocaleString(); else cartPriceEl.querySelector("span").innerHTML = cartPrice;
                            if (cartOldPrice.toString().length > 4) cartOldPriceEl.querySelector("span").innerHTML = cartOldPrice.toLocaleString(); else cartOldPriceEl.querySelector("span").innerHTML = cartOldPrice;
                            ...
                            cartProductSubProducts.forEach((cartProductSubProduct => {
                                ...
                                if (cartSubPrice.toString().length > 4) cartSubPriceEl.querySelector("span").innerHTML = cartSubPrice.toLocaleString(); else cartSubPriceEl.querySelector("span").innerHTML = cartSubPrice;
                    ...
                    if (cartTotalPriceWithoutDiscount.toString().length > 4) cartTotalPriceWithoutDiscountEl.innerHTML = cartTotalPriceWithoutDiscount.toLocaleString(); else cartTotalPriceWithoutDiscountEl.innerHTML = cartTotalPriceWithoutDiscount;
                    if (cartTotalPrice.toString().length > 4) cartTotalPriceEl.innerHTML = cartTotalPrice.toLocaleString(); else cartTotalPriceEl.innerHTML = cartTotalPrice;
                    if (cartTotalPrice.toString().length > 4) cartTotalPriceShortEl.innerHTML = cartTotalPrice.toLocaleString() + ` <font class="rub">i</font>`; else cartTotalPriceShortEl.innerHTML = cartTotalPrice + ` <font class="rub">i</font>`;
                    if (0 == cartTotalDiscount) cartTotalDiscountEl.innerHTML = "0"; else if (cartTotalDiscount.toString().length > 4) cartTotalDiscountEl.innerHTML = (-1 * cartTotalDiscount).toLocaleString(); else cartTotalDiscountEl.innerHTML = (-1 * cartTotalDiscount).toString();
                } else {
                ...
                cartInputQuantity.forEach((el => {
                    el.querySelector("input").addEventListener("change", (() => {
                        ...
                        if (max && parseInt(el.querySelector("input").value) > max) {
                            ...
                            if (parseInt(el.querySelector("input").value) < min) el.querySelector("input").value = min;
                            if (parseInt(el.querySelector("input").value) < 1) el.querySelector("input").value = 1;
            ...
            datePickers.forEach((el => {
                picker = datepicker(el, {
                    ...
                    formatter: (input, date, instance) => {
                        ...
                        const shortValue = date.toLocaleDateString("ru-RU", {
                            month: "long",
                            day: "numeric"
                        });
            ...
            if (editAdresses.length) {
                ...
                editAdresses.forEach((e => {
                    e.addEventListener("click", (() => {
                        ...
                        if (e.closest(".popupAddress")) editInputs = editPopup.querySelectorAll("[data-name]"); else if (e.closest(".popupLegalface")) editInputs = editLegalPopup.querySelectorAll("[data-name]");
            ...
            document.addEventListener("beforePopupClose", (function(e) {
                ...
                if (currentPopupElement.classList.contains("popupAddress") && !currentPopupElement.classList.contains("popupLegalface")) {
                    ...
                    if (currentAdress) {
                        ...
                        let intercom;
                        let comment;
                        if (currentAdressEl.querySelector('[data-value="adress"]')) adress = currentAdressEl.querySelector('[data-value="adress"]').innerText; else adress = "";
                        if (currentAdressEl.querySelector('[data-value="flat"]')) flat = currentAdressEl.querySelector('[data-value="flat"]').innerText; else flat = "";
                        if (currentAdressEl.querySelector('[data-value="entrance"]')) entrance = currentAdressEl.querySelector('[data-value="entrance"]').innerText; else entrance = "";
                        if (currentAdressEl.querySelector('[data-value="floor"]')) floor = currentAdressEl.querySelector('[data-value="floor"]').innerText; else floor = "";
                        if (currentAdressEl.querySelector('[data-value="intercom"]')) intercom = currentAdressEl.querySelector('[data-value="intercom"]').innerText; else intercom = "";
                        if (currentAdressEl.querySelector('[data-value="comment"]')) comment = currentAdressEl.querySelector('[data-value="comment"]').innerText; else comment = "";
                        document.querySelector("[data-adress]").innerHTML = `\n        <div class="buyers-ordering__head">\n          <div class="buyers-ordering__title">Доставка <span class="buyers-ordering__dateshort">${(new Date).toLocaleDateString("ru-RU", {
                            month: "long",
                            day: "numeric"
                    ...
                    if (currentLegalfaceEl) {
                        ...
                        let bik;
                        let checkingacc;
                        if (currentPopupElement.querySelector('[data-value="companyname"]')) companyname = currentPopupElement.querySelector('[data-value="companyname"]').innerText; else companyname = "";
                        if (currentPopupElement.querySelector('[data-value="phone"]')) phone = currentPopupElement.querySelector('[data-value="phone"]').innerText; else phone = "";
                        if (currentPopupElement.querySelector('[data-value="inn"]')) inn = currentPopupElement.querySelector('[data-value="inn"]').innerText; else inn = "";
                        if (currentPopupElement.querySelector('[data-value="bik"]')) bik = currentPopupElement.querySelector('[data-value="bik"]').innerText; else bik = "";
                        if (currentPopupElement.querySelector('[data-value="checkingacc"]')) checkingacc = currentPopupElement.querySelector('[data-value="checkingacc"]').innerText; else checkingacc = "";
            ...
            orderingAdresses.forEach((e => {
                e.addEventListener("change", (() => {
                    orderingAdresses.forEach((el => {
                        if (el.checked) el.parentElement.classList.add("popupAddress__item_active"); else el.parentElement.classList.remove("popupAddress__item_active");
                    }));
                }));
            }));
        }
        ...
        function checkOrderingStatus() {
            ...
            if (buyersAdress.offsetHeight > 0 && buyersAdress.querySelector(".buyers-ordering__link") || buyersLegalface.offsetHeight > 0 && buyersLegalface.querySelector(".buyers-ordering__link")) orderingCart.classList.add("ordering-cart_error"); else orderingCart.classList.remove("ordering-cart_error");
        }
        ...
        function homePageFunctions() {
            ...
            if (document.querySelector(".scrollbox")) setTimeout((() => {
